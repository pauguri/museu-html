...
<body>
    <?php
        ...
        # se asigna un alias a las columnas repetidas ("nombre" de P02usuarios y "nombre" de P02categorias) con el parámetro AS
...
<?php
    ...
    # estas variables guardan el useragent y la ip pública del usuario, además de la fecha y hora actuales
